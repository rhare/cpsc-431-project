...
class PlayerStatistic
{
   ...
   function playingTime() 
   {
     ...
     // void playingTime($minutes, $seconds)
     else if( func_num_args() == 2 )
     {
   ...
   // playerID() prototypes:
   //   int playerID()               returns the playerID
   //
   //   void playerID(int $value)    set object's playerID attribute
   function playerID() 
   {
     // int playerID()
     if( func_num_args() == 0 )
   ...
   function __construct($name="", $time="0:0", $points=0, $assists=0, $rebounds=0, $player_id=NULL)
   {
